...
public class MoveListRecyclerFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setHasOptionsMenu(true); // Indica que este fragmento tiene opciones de menú.
        boton = boton.findViewById(R.id.botonIrJuegos);
   ...
   /* public void lanzarJuegos() {
        Intent i = new Intent(this, JuegosPokemon.class);
        startActivity(i);
    }*/
